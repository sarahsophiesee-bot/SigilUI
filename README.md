...
A key‑verification gate for Roblox script hubs, shaped like a **sealed access pass**. Same engine as [Onyx]([./README_OnyxUI.md](https://github.com/sarahsophiesee-bot/OnyxUI/blob/main/README.md)), a completely different idea of what a key screen looks like.
